...
class Block:
    ...
    def __init__(self, index, transactions, previous_block_hash,current_version=3, difficulty_level=1, metadata=''):
        self._index = index
    ...
    def generate_hash(self):
        ...
        while True: # Keep generating a new hash value
            ...
            if int(hash_value[:self._difficulty_level], 16) == 0: # Check for difficulty level.
                return hash_value #check this any 
            self._nonce += 1
...
if __name__ == "__main__":
    ...
    new_block = Block(index=10, transactions=transactions, previous_block_hash=previous_block_hash,current_version=3,difficulty_level=5)
